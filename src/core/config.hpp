...
#define BOOKFILER_LIBRARY_SORT_FILTER_TREE_WIDGET_TREE_MODEL_PARENT 0
#define BOOKFILER_LIBRARY_SORT_FILTER_TREE_WIDGET_TREE_MODEL_ROW_COUNT 0
#define BOOKFILER_LIBRARY_SORT_FILTER_TREE_WIDGET_TREE_MODEL_COLUMN_COUNT 0
#define BOOKFILER_LIBRARY_SORT_FILTER_TREE_WIDGET_TREE_MODEL_DATA 0
#define BOOKFILER_LIBRARY_SORT_FILTER_TREE_WIDGET_TREE_MODEL_INDEX 0
